...
**Download da loja = tag `v3.2.5-free`.** Não use a pré-release do topo da lista (`v4.0.0-rc2`) como se fosse o Free.
...
| Campo | Valor |
| ----- | ----- |
| Download da loja | `v3.2.5-free` (Free / balcão) |
...
| Release | <https://github.com/chmulato/caracore-pdv-releases/releases/tag/v3.2.5-free> |
| Loja | <https://pdv.caracore.com.br/download.html> |

O trecho `free-free` no nome do ZIP é o nome publicado, não um segundo plano.

### Artefatos v3.2.5-free

| Artefato | Plataforma | SHA256 |
| -------- | ---------- | ------ |
| `caracore-pdv-v3.2.5-free-free-windows-x64.zip` | Windows 10/11 x64 | `1b9b5062437f34c83d75eac89fd18df7993e6b15d1677dfb6350cfe975635bc8` |
| `caracore-pdv-v3.2.5-free-free-linux-x64.zip` | Linux x64 (Ubuntu 20.04+) | `40cfdf0f55f9476725920bb276e090239b2e2c106747719cac5ba39a427f54ba` |
| `caracore-pdv-v3.2.5-free-free-macos-x64.zip` | macOS 12+ x64 (Intel) | `2cbcdead4476e16fe4deb8cda2d0f12fa692999f6d76104abad39cf412447da8` |
...
- `v3.2.5-free` é a oferta pública atual: UI de balcão no browser (criar produto, vender, pagar em dinheiro), porta 8080, `/login`, Java 25+.
...
A vitrine em `docs/` segue a trilha Java 25 da matriz, com SQLite local e soberania localhost. O download público maduro é a tag `v3.2.5-free`. O candidato `v4.0.0-rc2` (Quarkus + Qute) está como pré-release e não substitui a degustação Free. O GA do v4 permanece previsto para 08/11/2026.

Notas da versão atual: <https://pdv.caracore.com.br/wiki-release-v3-2-5-free.html>
...
| `docs/versoes.html` | Versão atual (3.2.5-free) e prévia (4.0.0-rc2) |
| `docs/wiki-release-v3-2-5-free.html` | Notas do canal Free atual |
...
- página de download apontando para a tag pública `v3.2.5-free` (Windows, Linux e macOS);
