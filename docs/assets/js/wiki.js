/**
 * Wiki Estrutural CaraCore-PDV â€” Sidebar, busca e TOC
 * v1.0.13
 */
(function () {
  "use strict";
  ...
  // TOC dinÃ¢mico: preenche #wikiToc a partir de .wiki-main-content section[id]
  ...
  if (tocEl && mainContent) {
    ...
    if (sections.length) {
      ...
      nav.setAttribute("aria-label", "Nesta pÃ¡gina");
      ...
      // IntersectionObserver: marca link ativo conforme a seÃ§Ã£o entra na viewport
